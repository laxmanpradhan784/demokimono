...
$sql = "SELECT id, name, price, image FROM product WHERE status = 'active' ORDER BY uploaded_at DESC";
                    ...
                    <div class="row">
                        <?php while ($product = $result->fetch_assoc()) {
                            ...
                            if (!file_exists($imagePath)) {
                                $imagePath = '../assets/img/shop/default.jpg';
                            }
                        ?>
                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                                <div class="product_item">
                                    <a href="product_detail.php?id=<?php echo htmlspecialchars($product['id']); ?>" class="product_thumb">
                                        <div class="product_imagebox">
                                            <img class="primary_img" src="<?php echo $imagePath; ?>" alt="<?php echo htmlspecialchars($product['name']); ?>">
                                        </div>
                                    </a>
