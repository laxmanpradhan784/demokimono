            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                <div class="grid-item">
                    <a href="book_appointment.php" class="wptb-item--image">
                        ...
                        style="width: 500px; height: 400px; border-radius: 20px; border: 5px solid; border-image: linear-gradient(45deg, #007bff, #00ff7f) 1;">
                    </a>
                    <div class="wptb-item--holder">
                        <h5 class="wptb-item--subtitle" 
                        style="font-size: 1.5rem; font-weight: bold; color: white; text-align: center; margin: 10px 0; text-transform: uppercase;
                        border: 2px solid #007bff; border-radius: 10px; padding: 40px; background: linear-gradient(45deg, #007bff, #00ff7f);
                        width: 260px; height: 50px; display: flex; align-items: center; justify-content: center; cursor: pointer;"
